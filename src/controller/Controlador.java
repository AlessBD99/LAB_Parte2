...
public class Controlador {
    ...
    public void datosDeportista(Deportista dep, JTextField cedulaTxt, JTextField nombreTxt, JTextField edadTxt, JTextField pesoTxt, JTextField alturaTxt, JTextArea direccionTxt, JTextField frecuenciaCardiacaTxt, JComboBox sexoJcombo, JComboBox tipoEjercicioJcombo, JComboBox frecuenciaEntrenamientoJcombo) {
        int numEntero;
        double numDouble;
    ...
    public void datosEntrenador(Gimnasio gym, Entrenador ent, JTextField cedulaTxt, JTextField nombreTxt, JTextField edadTxt, JTextField pesoTxt, JTextField alturaTxt, JTextArea direccionTxt, JTextField txtEspecialidad, JComboBox sexoJcombo, JTextField txtExperiencia) {
        int numEntero;
        double numDouble;
